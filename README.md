...
- ✏️ `2`,`6`,`8` Add a link to different commits you've already completed on public repo.
- ✏️ `7` Add the full path to any local `.git` config folder on your computer.
- ✏️ `9`,`10` Add links to existing (public) git projects you've created.
